...
This project arose from a situation in which someone's arm was broken, and they were looking for solutions online to help them type with one hand. There were surprisingly few options available, and the most intriguing idea didn't have a publicly available implementation. The final result of the project was a version of an old key-switching mechanism that you could try out in your browser or download for use on your Windows computer, and it made one-handed typing a completely practical thing.
