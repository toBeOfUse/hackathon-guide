...
## Projects From The Past <span className="md:hidden text-base block">(Swipe for more)</span>
...
<p className='text-center mb-6'>**For Inspiration**: [Kaggle's Featured Datasets](https://www.kaggle.com/datasets)</p>
